...
_logo_line_3_ = ('%s| |) | |\/| | _ \ _|  %s│   %s• Code By RK. RIAZKHAN •   %s│'%(_P_,_U_,_P_,_U_))
_logo_line_4_ = ('%s|___/|_|  |_|___/_|   %s│ %sGithub.com/Riazkiller/dmbf %s│'%(_P_,_U_,_P_,_U_))
...
_escylipsce_ = '__RK_Love_RK__'
_uscylupsci_ = '__My_Love____RK____RK_Love_RK____RK____Forever__'
